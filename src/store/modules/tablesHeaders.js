export default {
  ...
  state: {
    mediationTableHeaders: [
      { text: "App", value: "appName", align: "start", width: "385" },
      { text: "DAU", value: "dau", align: "end", width: "150" },
      { text: "ARPU", value: "arpu", align: "end", width: "160" },
      { text: "Immersions", value: "immersions", align: "end", width: "215" },
      { text: "ECPM", value: "ecpm", align: "end", width: "160" },
      { text: "Est. Earnings", value: "est", align: "end", width: "210" },
    ],
    applicationsTableHeaders: [
      ...
      {
        text: "Use Intertitial",
        value: "useIntertitial",
        align: "center",
        sortable: false,
      },
      {
